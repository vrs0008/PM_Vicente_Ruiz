...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int pedete = sp.load(this, R.raw.pedete, 1);
        Button bEfectoSonido = findViewById(R.id.bEfectoSonido);

        bEfectoSonido.setOnClickListener(v -> {
            sp.play(pedete, 1, 1, 1, 0, 1);
        });

        //Continuar con el reproductor
